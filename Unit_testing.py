...
class DuelingDDQNTest(unittest.TestCase):
    ...
    def test_network_initialization(self):
        ...
        self.assertEqual(
            self.dueling_ddqn.advantage_stream.out_features, self.action_dim
        )
...
class TestRewardFunctions(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.env.vehicle.get_transform.return_value.location.distance = MagicMock(
            return_value=0
        )  # distance between roads center and car
    ...
    def create_environment(
        ...
        self.env.vehicle.get_transform.return_value.location.distance = MagicMock(
            return_value=distance_from_center
        )
        ...
        waypoint.transform.location.distance = MagicMock(
            return_value=distance_from_center
        )
    ...
    def test_reward_function_1(self):
        ...
        expected_rewards = [
            ...
            500,
            -1000,
            500 - math.pi / 180 * 10 * 100,
            650 - math.pi / 180 * 5 * 100,
            -100 - math.pi / 180 * 5 * 100,
        ]
        ...
        for case in test_cases:
            with self.subTest(case=case):
                ...
                self.assertAlmostEqual(
                    reward, expected_rewards[i], places=5
                )  # Assuming that reward function 1 might penalize for certain actions
    ...
    def test_reward_function_3(self):
        ...
        expected_rewards = [
            ...
            10 + 2,
            8,
            10 + 2 * math.cos(math.pi / 180 * 10),
            13 + 2 * math.cos(math.pi / 180 * 5),
            13 + 2 * math.cos(math.pi / 180 * 5) - 4 - 13 / (10 / 2.5),
        ]
        expected_done = [False, False, True, False, False, True]
        i = 0
        for case in test_cases:
    ...
    def test_reward_function_4(self):
        ...
        expected_rewards = [
            ...
            math.sqrt(10) + 1,
            math.sqrt(10) + 1,
            math.sqrt(10) + math.cos(math.pi / 180 * 10),
            math.sqrt(13) + math.cos(math.pi / 180 * 5),
            math.sqrt(13) + math.cos(math.pi / 180 * 5) - 2 - 13 / (10 / 2.5),
            math.sqrt(13)
            + math.cos(math.pi / 180 * 5)
            - 2
            - 13 / (10 / 2.5)
            - 2 * 0.15,
            math.sqrt(13)
...
class EnvironmentTest(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.reward_function = [
            1
        ]  # Using the first type of reward function as an example.
        cls.env = Environment(
            cls.client, cls.car_config, cls.sensor_config, cls.reward_function
        )
    ...
    def test_environment_reset(self):
        ...
        self.assertIsNotNone(
            state, "The environment did not return a valid initial state."
        )
        ...
        vehicle_num = [actor.id for actor in actor_list if "vehicle" in actor.type_id]
        sensor_num = [actor.id for actor in actor_list if "sensor" in actor.type_id]
...
class ReplayBufferTest(unittest.TestCase):
    ...
    def test_store_experience(self):
        ...
        self.assertEqual(
            ...
            initial_size + 1,
            "Experience was not stored correctly.",
        )
    ...
    def test_sample_batch(self):
        ...
        self.assertEqual(
            len(sample),
            batch_size,
            "Sampled batch size does not match the requested size.",
        )
